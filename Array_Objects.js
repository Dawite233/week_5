...
let getDate = iss_location.iss_position
console.log(getDate)

let latitudeData = getDate.latitude
console.log(`The Latitude is ${latitudeData}`)

let longitudeData = getDate.longitude
console.log(`The longitude is ${longitudeData}`)
...
let get_cat = cats_and_owners
console.log(get_cat)

let catData = get_cat.cat
console.log(`The cat name is ${catData}`) // indexOf
...
//     console.log(`${catOwners_s}  cat is called ${catNameOwners}`)
// }
...
// TODO print the ids of each of the Physics Nobel laureates. Your code should still work without
//  modification if a laureate was added, or removed.

let phy = nobel.category
console.log(phy)
